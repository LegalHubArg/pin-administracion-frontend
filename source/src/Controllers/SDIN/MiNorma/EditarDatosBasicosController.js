...
import VistaEditarDatosBasicos from '../../../Pages/SDIN/MiNorma/EditarDatosBasicos';
...
const EditarDatosBasicos = props => {
    return (
        <Layout isHeader={true} isBotonUsuario={true} isFooter={true}>
                ...
                <div className="container">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item">Editar Norma</li>
                        </ol>
                    </nav>
                </div>
            </header>
            <div className="container">
                <header>
                    <h1 className="mb-3">EDITAR NORMA</h1>
                </header>
                <hr />
            </div>
            <VistaEditarDatosBasicos />
        </Layout>
