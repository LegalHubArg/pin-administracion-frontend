...
const MisNormas = props => {
    ...
    const [form, setForm] = useState({ ...initForm, idNormasEstadoTipo: 2, tipoFecha: "Sanción" });
    ...
    const getNormas = async () => {
        ...
        try {
            let body = {
                ...form, ...paginacion, ...ordenamiento, calcularTotal,
                user: form.idUsuario
            };
            let token = localStorage.getItem("token");
                ...
                <div className="container responsive mb-5" id="pagina-consultas">
                                        ...
                                        <form className="form" onSubmit={e => handleSubmit(e)}>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div class="d-flex justify-items-around">
                                                    <input type="text" className="form-control campo-numero-norma" id="normaNumero-desde"
                                                        name="normaNumero-desde" pattern="[0-9]*" onChange={e => handleFormChange(e)}
                                                        value={form.numeroNorma_desde} placeholder="Desde" />&nbsp;-&nbsp;
                                                    <input type="text" className="form-control campo-numero-norma" id="normaNumero-hasta"
                                                        name="normaNumero-hasta" pattern="[0-9]*" onChange={e => handleFormChange(e)}
                                                        value={form.numeroNorma_hasta} placeholder="Hasta" />
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                ...
                                                <select className="custom-select" id="idNormasEstadoTipo" name="idNormasEstadoTipo"
                                                    onChange={e => handleFormChange(e)} value={(form.idNormasEstadoTipo != null) ? form.idNormasEstadoTipo : null}
                                            ...
                                            <div className="form-group d-flex align-items-center">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="checkVigenciaEspecial"
                                                        id="checkVigenciaEspecial" checked={form.checkVigencia} onChange={e => handleFormChange(e)} />
                                            ...
                                            <div className="form-group">
                                                ...
                                                <select className="custom-select" id="idRama" name="idRama" onChange={e => handleFormChange(e)}
                                                    value={form.idRama != null ? form.idRama : -1} disabled>
                                                    <option selected value={-1}></option>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <select className="custom-select" id="idTema" name="idTema"
                                                    onChange={e => handleFormChange(e)} value={-1} disabled
                                                ><option selected value={-1}></option>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <select disabled className="custom-select" id="analista" name="analista"
                                                    onChange={e => handleFormChange(e)} value={form.analista}
                                                >
                                                    <option>{datosSesion.nombre}</option>
                                                </select>
                                            </div>
                                            <div className="form-group">
                                                ...
                                                <select className="custom-select" id="tiposPalabras" name="tiposPalabras"
                                                    ...
                                                    <option></option>
                                                    <option>Frase exacta:</option>
                                                    <option>Con las palabras:</option>
                                                    <option>Sin las palabras:</option>
                                                    <option>Con alguna de:</option>
                                                </select>
                                            </div>
                                            <div className="form-group dos-columnas">
                                                <label for="palabras">Palabras</label>
                                                <textarea type="text" className="form-control" id="palabras" name="palabras" pattern="[0-9]*"
                                                    onChange={e => handleFormChange(e)} value={form.palabras} />
                                            </div>
                                            <div className="form-group">
                                                <label for="clase">Clase</label>
                                                <select className="custom-select" id="clase" name="clase" pattern="[0-9]*"
                                                    onChange={e => handleFormChange(e)} value={form.idClase ? form.idClase : -1} disabled>
                                                    <option selected value={-1}></option>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <select className="custom-select" id="idSeccion" name="idSeccion"
                                                    onChange={e => handleFormChange(e)} value={(form.idSeccion != null) ? form.idSeccion : -1} disabled
                                                ><option selected value=""></option>
                    ...
                    {(loadingNormas) ? (<Spinner />) : (
                        (normas && normas.length > 0) ? (
                            ...
                            <div>
                                <br />
                                <p>No hay normas para este usuario.</p>
                                <br />
                            </div>
                        )
                    )
