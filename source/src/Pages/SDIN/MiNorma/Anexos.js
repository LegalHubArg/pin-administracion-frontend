...
const Anexos = props => {
  ...
  const handleEditorChange = (e) => {
    ...
    if (isLoading) {
        ...
        return (
            <>
                <div className="container responsive mb-5" id="pagina-anexos">
                    ...
                    <div className="accordion" id="accordion">
                              ...
                              <div className="card-body">
                                  <div className="">
                                          <div className="form-group carga-documentos">
                                            <label for="file-input" class="custom-file-upload">Documento Anexo</label>
                      ...
                      <div className="card">
                          ...
                          <button className="btn btn-success btn-sm mr-2">Agregar Anexo</button>
                    <div>
