...
const Descriptores = props => {
  ...
  const handleEditorChange = (e) => {
    ...
    if (isLoading) {
        ...
        return (
            <>
                <div className="container responsive mb-5" id="pagina-descriptores">
                    <form className="form" onSubmit={e => handleSubmit(e)}>
                    <div className="accordion" id="accordion">
                        <div className="card">
                            <button
                            >
                                DESCRIPTORES DE NORMA XXX
                            </button>
                            <div id="collapse1" className="collapse" data-parent="#accordion">
                                <div className="card-body">
                                    <div className="filtros-busqueda">
                                            <div className="form-group">
                                                <label for="idSeccion">Lista de Descriptores</label>
