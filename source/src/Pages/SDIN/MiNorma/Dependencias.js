...
const EditarDatosBasicos = props => {
  ...
  const handleEditorChange = (e) => {
    ...
    if (isLoading) {
        ...
        return (
            <>
                <div className="container responsive mb-5" id="pagina-dependencias">
                    <form className="tab" onSubmit={e => handleSubmit(e)}>
                            ...
                            <div id="collapse1" className="collapse" data-parent="#accordion">
                                <div className="card-body">
                                    <div className="filtros-busqueda">
                                            ...
                                            <button class="btn btn-primary" type="submit" id="boton-buscar">Agregar Dependencia</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-bordered table-hover" >
                                            ...
                                            <tbody>
                                                            <tr>
                                                                ...
                                                                <td>-</td>
                                                                <td>
                                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalBorrarBoletin">
                                                                        Eliminar
                                                                    </button>
                                                                </td>
                                                            </tr>
